...
public partial class SamplePages_TabbedCRUDReview : System.Web.UI.Page
{
    ...
    protected void SearchResults_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //AlbumTitle uses bound field and finds the cell using agrow.Cells[1]. It is index 1 because AlbumID is index 0 even though its not seen by user
    ...
    // This is just to get rid of selected row color on page change
    ...
    protected void Add_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            item.ReleaseLabel = string.IsNullOrEmpty(ReleaseLabel.Text) ? null : ReleaseLabel.Text; //for a nullable field
